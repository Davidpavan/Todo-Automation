...
sed -i -e "s/TODO_IP_ADDR/todo.pavanzs.online/" /etc/nginx/sites-enabled/todo.conf && sed -i -e "s/LOGIN_IP_ADDR/login.pavanzs.online/" /etc/nginx/sites-enabled/todo.conf
Stat $?
